    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
          Create imaginative and visually stunning image through by DALL-E AI and share them through community
        </p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <FormField
            ...
            type='text'
            name='prompt'
            placeholder='an armchair in the shape of an avocadoe'
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
        ...
        <div className='mt-10'>
          ...
          <button
            type='submit'
            className='mt-3 text-white bg-[#6969ff] font-medium rounded-md text-sm
